...
def Get(key:str, addr=GRPC_SERVER) -> device_pb2.GetResponse:
...
def Set(key:str, value:str, addr=GRPC_SERVER) -> device_pb2.SetResponse:
...
def GetMutiple(keys:list[str], addr=GRPC_SERVER) -> device_pb2.GetMultipleResponse:
...
def SetMultiple(key_value_pairs:tuple[str,str], addr=GRPC_SERVER) -> device_pb2.SetMultipleResponse:
